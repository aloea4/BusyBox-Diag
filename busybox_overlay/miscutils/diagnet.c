//config:config DIAGNET
//config:	bool "diagnet (diag network metadata monitor)"
//config:	default n
//config:	help
//config:	Lightweight procfs-based network connection metadata monitoring tool.
//applet:IF_DIAGNET(APPLET_NOEXEC(diagnet, diagnet, BB_DIR_USR_BIN, BB_SUID_DROP, diagnet))
//kbuild:lib-$(CONFIG_DIAGNET) += diagnet.o diagnet_state.o diagnet_collect.o diagnet_filter.o diagnet_analyze.o diagnet_policy.o diagnet_output.o

//usage:#define diagnet_trivial_usage
//usage:       "[OPTIONS]"
//usage:#define diagnet_full_usage "\n\n"
//usage:       "Passive kernel socket state observer."
//usage:     "\n"
//usage:     "\nObserve TCP/UDP connection metadata exported"
//usage:     "\nvia /proc/net/tcp and /proc/net/udp."
//usage:     "\n"
//usage:     "\nOptions:"
...
//usage:     "\n\n    --no-header"
//usage:     "\n        Disable table/raw headers"
//usage:     "\n\n    --proto tcp|udp|all"
//usage:     "\n        Filter protocol class"
//usage:     "\n\n    --state STATE | --listen"
//usage:     "\n        Filter TCP state"
//usage:     "\n"
//usage:     "\nExamples:"
...
int diagnet_main(int argc, char **argv) MAIN_EXTERNALLY_VISIBLE;
