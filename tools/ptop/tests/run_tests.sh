...
cc -Wall -Wextra -std=c99 -D_POSIX_C_SOURCE=200809L -DPTOP_ENTRY_NAME=ptop_entry_test -I. -I../../libdiag/include \
  tests/test_ptop_logic.c ptop.c ptop_snapshot.c ptop_delta.c ptop_tree.c ptop_filter.c ptop_policy.c ptop_render_tty.c ptop_output.c ptop_signal.c \
  -o tests/test_ptop_logic.bin ../../libdiag/libdiag.a
